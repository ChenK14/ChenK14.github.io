  ...
  const types = [
    {
      ...
      id: 1,
      description:
        "Representing a fetch call the fetch a resource, such as fetch the dynamic model",
    },
    {
      name: "mark",
      id: 2,
      description:
        "Representing the marking of a stage, such as the start and end of load_renderer",
    },
    ...
    { name: "paint", id: 4, description: "Representing a paint stage" },
    {
      name: "navigation",
      id: 5,
      description: "Representing the navigation call",
    },
    { name: "first-input", id: 6, description: "" },
    {
      ...
      id: 7,
      description:
        "Representing a fetch call to a frog.wix domains, it is not shown by default since it doesnt affect the loading time",
    },
    {
      name: "cloudflare",
      id: 8,
      description:
        "Representing a fetch call to a cloudflare domains, it is not shown by default since it doesnt affect the loading time",
    },
  ];
